    ...
    <div class="container">
        <article class="docs-article" id="section-1">
            <header class="docs-header">
                <h1 class="docs-heading">SubscriptionCreated</h1>
                <section class="docs-intro">
                    <p>The test form is only available for requests from the local machine</p>
                </section><!--//docs-intro-->
            </header>
            <div>
                <code>POST: {{$request_url}}/SubscriptionCreated</code>
                <h6>
                    Request Body:
                </h6>
            </div>
            <div class="mb-2 p-2 bg-dark text-white">
            ...
            <div class="mb-2 p-2 bg-dark text-white">
                <pre id="response" class="text-white">
                </pre>
            </div>
        </article>
    </div>
